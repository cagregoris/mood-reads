...
VALUES
  ...
  (
    ...
    ARRAY['unpleasant-calm', 'unpleasant-energized', 'pleasant-calm'],
    ARRAY['sad', 'fearful', 'hopeful']
  ),
  (
  ...
  (
    ...
    ARRAY['unpleasant-calm', 'pleasant-energized'],
    ARRAY['sad', 'adventurous']
  ),
  (
    'A Man Called Ove',
    'Fredrik Backman',
    ...
    ARRAY['pleasant-calm', 'pleasant-energized'],
    ARRAY['hopeful', 'reflective', 'humorous']
  ),
  (
    'East of Eden',
    'John Steinbeck',
